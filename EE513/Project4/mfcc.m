...
%
%           1. Signal is subsampled to 8kHz
%           2. Spectrum amplitudes are computed with FFT
%           3. Uniform Hz axis points are mapped into the Mel axis
%           4. Mel cepstrum bands are segmented out and weighted with
%              trianglar windows.
%           5. The log base 10 of each band sum is taken and discrete cosine
%              transform function returns Mells Cepstrum Coefficeints.
%
% Input arguments
%       SOURCE - source signal, single channel sound signal with a minimum
%                sampling frequency of 8 kHz
%       FS     - Sampling frequency of source signal
%
% Output argument
%
...
mf = zeros(20,1);        % Pre allocating output mel cepstrum coefs
